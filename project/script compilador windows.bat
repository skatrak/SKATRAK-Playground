...
set OBJECTS_GEN="%OBJDIR%\shared_attributes.o" "%OBJDIR%\system.o" "%OBJDIR%\main.o" "%OBJDIR%\music.o" "%OBJDIR%\image.o" "%OBJDIR%\timekeeper.o" "%OBJDIR%\font.o" "%OBJDIR%\inifile.o" "%OBJDIR%\sfx.o" "%OBJDIR%\str_operations.o" "%OBJDIR%\menu.o" "%OBJDIR%\mainMenu.o" "%OBJDIR%\messagebox.o"
