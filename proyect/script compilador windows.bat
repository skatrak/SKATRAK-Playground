...
"%gpp%\g++.exe" -O2 -o "..\bin\windows\SKATRAK Playground.exe" "..\bin\windows\obj\main.o" "..\bin\windows\obj\image.o" "..\bin\windows\obj\music.o" "..\bin\windows\obj\system.o" "..\bin\windows\obj\timekeeper.o" -mwindows -lmingw32 -lSDLmain -lSDL -lSDL_mixer -lSDL_image -lSDL_ttf
if %errorlevel% neq 0 set error=true
